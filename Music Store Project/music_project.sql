...
--Question 4 - Which city has the best cutomers? We would like to throw a promotional Music Festival in the city we made
...
-- Question 6 - Write query to return the email, first name, last name, and gemre of all rock music listeners.
...
-- Return the name and millieseconds for each track. Order by the song length with the longest songs listed first.
...
-- Question 9 - Find out how much was spent by each customer on artists? Write a query to return 
